...
const Form = () => {
  ...
  return (
    <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
        ...
        <input type="email" placeholder="Digite o seu e-mail" className="rounded-lg py-2 px-2 text-sm placeholder:text-sm placeholder:text-stone-400" value = {email} onChange = {(e) => setEmail(e.target.value)}  />
        </div>
